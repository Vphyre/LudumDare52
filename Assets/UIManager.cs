...
public class UIManager : Singleton<UIManager>
{
    ...
    public void UpdateSeedUI () {
        cornSeedQtd.text = InventorySystem.Instance.cornSeedQtd.ToString();
        carrotSeedQtd.text = InventorySystem.Instance.carrotSeedQtd.ToString();
        potatoSeedQtd.text = InventorySystem.Instance.potatoSeedQtd.ToString();
    ...
    public void UpdateWeaponUI () {
        cornBullets.text = InventorySystem.Instance.cornBullets.ToString();
        carrotBullets.text = InventorySystem.Instance.carrotBullets.ToString();
        potatoBullets.text = InventorySystem.Instance.potatoBullets.ToString();
